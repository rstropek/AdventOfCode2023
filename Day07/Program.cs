...
class Hand : IComparable<Hand>
{
    ...
    public Hand(string hand)
    {
        for (int i = 0; i < 5; i++)
        {
            cardValues[i] = Array.IndexOf(cards, hand[i]);
        }
    }
    ...
    public HandType GetHandType()
    {
        ...
        foreach (int count in valueCounts)
        {
        ...
        if (fiveCount == 1) { return HandType.FiveOfAKind; }
        else if (fourCount == 1) { return HandType.FourOfAKind; }
        else if (threeCount == 1 && pairCount == 1) { return HandType.FullHouse; }
        else if (threeCount == 1) { return HandType.ThreeOfAKind; }
        else if (pairCount == 2) { return HandType.TwoPair; }
...
// In this class, 'J' acts as a Joker
class Hand2 : IComparable<Hand2>
{
    private static readonly char[] cards = ['J', '2', '3', '4', '5', '6', '7', '8', '9', 'T', 'Q', 'K', 'A'];
    private readonly int[] cardValues = new int[5];
    ...
    public HandType GetHandType()
    {
        ...
        int pairCount = 0, threeCount = 0, fourCount = 0, fiveCount = 0;
        for(var i = 1; i < valueCounts.Length; i++)
        {
        ...
        var jokers = valueCounts[0];
        if (jokers is 5 or 4 
            || (pairCount == 1 && jokers == 3)
            || (threeCount == 1 && jokers == 2)
            || (fourCount == 1 && jokers == 1)
            || fiveCount == 1) { return HandType.FiveOfAKind; }
        else if (jokers == 3
            || (pairCount == 1 && jokers == 2)
            || (threeCount == 1 && jokers == 1)
            || fourCount == 1) { return HandType.FourOfAKind; }
        else if (threeCount == 1 && pairCount == 1) { return HandType.FullHouse; }
        else if (jokers == 2
            || (pairCount == 1 && jokers == 1)
            || threeCount == 1) { return HandType.ThreeOfAKind; }
        else if (pairCount == 2) { return HandType.TwoPair; }
        else if (jokers == 1 || pairCount == 1) { return HandType.OnePair; }
        else { return HandType.HighCard; }
    }
